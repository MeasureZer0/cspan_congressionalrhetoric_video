...
#SBATCH -c 16              # Number of CPU cores. Can go as high as 128. Each additional CPU core adds around 1.9GB of RAM so to get more memory, add more CPU cores.
...
python3 -u preprocessing/crop_faces.py >logs/crop_faces_${SLURM_JOBID}.log 2>&1
